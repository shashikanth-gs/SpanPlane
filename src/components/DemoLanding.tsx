  ...
  return (
    <main className="demo-landing">
      <nav className="demo-nav" aria-label="Primary navigation">
        <Link className="demo-brand" href="/"><img src="/icon.svg" width="24" height="24" alt="Logo" style={{ marginRight: '8px' }} />SpanPlane</Link>
        <a href="https://github.com/shashikanth-gs/spanplane" target="_blank" rel="noreferrer">GitHub</a>
      </nav>
      <section className="demo-hero">
        <p className="demo-eyebrow">Open-source A2A testing workbench</p>
        <h1>Test agents as real applications.</h1>
        <p>SpanPlane is an interactive studio for Agent Card discovery, task and stream behavior, protocol operations, and content-aware artifacts across A2A v1.0 and v0.3.</p>
        <div className="demo-actions"><Link className="button primary" href="/workbench">Open public demo</Link><a className="button secondary" href="https://www.npmjs.com/package/spanplane" target="_blank" rel="noreferrer">Run locally with npx</a></div>
